...
function App() {
  ...
  const handleChatSelect = (chat) => {
    if (chat) {
      ...
      // You might want to disconnect from current agent and connect to chat-specific agent
  ...
  const handleChatCreated = (newChat) => {
    ...
    // Refresh chat list if you have a ref to ChatList
  };
  // Add this to get chat history for the selected chat
  const {
  ...
  return (
    <div className="app-container">
      ...
      >
        <div
          className={`conversation-history-sidebar ${isLeftSidebarCollapsed ? "collapsed" : ""}`}
        >
          <div className="conv-history-header"></div>
